package im.arena.sample.pinnedcard

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import im.arena.basiccard.BasicCardState
import im.arena.sample.R
import kotlinx.android.synthetic.main.activity_pinned_card.*

class ActivityPinnedCard : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pinned_card)
